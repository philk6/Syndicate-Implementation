...
begin
  ...
  -- >>> FALLBACK ADDED (runs BEFORE deleting debits) <<<
  -- If nothing to credit yet (e.g., legacy rows have order_id NULL and didn’t map),
  -- compute by matching the order number in description for companies on this order.
